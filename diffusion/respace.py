...
class SpacedDiffusion(GaussianDiffusion):
    ...
    def __init__(
        ...
        beta: Optional[DictConfig] = None,
        gaussian_diffusion: Optional[DictConfig] = None,
    ):
        ...
        betas = get_named_beta_schedule(
            beta.schedule_name, num_diffusion_timesteps, beta.scale_betas
        )
        self.original_num_steps = len(betas)

        base_diffusion = GaussianDiffusion(
            betas=betas, **gaussian_diffusion
        ...
        gaussian_diffusion["betas"] = np.array(new_betas)
